...
0 12 16-30 9 * node /scripts/jd_carnivalcity.js >> /scripts/logs/jd_carnivalcity.log 2>&1
##############长期活动##############
# 签到
...
# 京喜财富岛合成月饼
11 * 10-22 9 * node /scripts/jd_cfd_mooncake.js >> /scripts/logs/jd_cfd_mooncake.log 2>&1 
