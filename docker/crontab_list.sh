...
0 18 * 4 * node /scripts/jd_carnivalcity.js >> /scripts/logs/jd_carnivalcity.log 2>&1
2 18 * 4 * node /scripts/jd_carnivalcity_card.js >> /scripts/logs/jd_carnivalcity_card.log 2>&1
##############长期活动##############
# 签到
